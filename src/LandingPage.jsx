...
const CourseSection = ({ title, courses }) => (
  <section style={{ padding: "40px 20px", backgroundColor: "#191B21" }}>
    <h2 style={{ textAlign: "center", color: "#FFC107", fontSize: "28px", marginBottom: "20px" }}>{title}</h2>
...
const LandingPage = () => {
  return (
    <div>
      <ScrollToTop />
      <header style={{ backgroundColor: "#343A45", padding: "60px 20px", textAlign: "center" }}>
        <h2 style={{ color: "#FFC107", fontSize: "32px", marginBottom: "20px" }}>
          Welcome to LearnCodeEra, your gateway to web development!
        </h2>
        <NavLink to={"/HTMLcourse/IntroductionH"} style={{ textDecoration: "none" }}>
          <button style={{
            backgroundColor: "#FFC107",
            color: "#191B21",
            border: "none",
